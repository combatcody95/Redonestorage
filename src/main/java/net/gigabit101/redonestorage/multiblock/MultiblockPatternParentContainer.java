...
final class MultiblockPatternParentContainer implements ParentContainer {
    private final MultiblockCrafterBlockEntity blockEntity;

    MultiblockPatternParentContainer(final MultiblockCrafterBlockEntity blockEntity) {
